...
import ProductCard_mobile from "../src/components/ProductCard_mobile.vue";
    ...
    async fetch() {
     ...
     methods:{
        ...
        try{
            this.allProducts = await this.$axios.$get(`http://localhost:3000/api/movies/${requestedOrder}`)     
        }catch(err){
            console.log(err)
        }
    },
     ...
     async sortProductsByName(requestedOrder) {
        try{
            this.allProducts = await this.$axios.$get(`http://localhost:3000/api/movies&sortbyname/${requestedOrder}`)     
        }catch(err){
            console.log(err)
        }
    },
