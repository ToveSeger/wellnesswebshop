...
export default {     
    ...
    methods:{
        ...
        try{
            this.allProducts = await this.$axios.$get(`http://localhost:3000/api/outlet/${requestedOrder}`)     
        }catch(err){
            console.log(err)
        }
     ...
     async sortProductsByName(requestedOrder) {
        try{
            this.allProducts = await this.$axios.$get(`http://localhost:3000/api/outlet&sortbyname/${requestedOrder}`)     
        }catch(err){
            console.log(err)
        }
    }
